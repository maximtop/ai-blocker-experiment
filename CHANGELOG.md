...
- Add HTML-in-Canvas element screenshot capture for vision rules, including
  offscreen matches and image resource inlining.

### Changed

- Make HTML-in-Canvas the primary screenshot mode by default, require Chrome
  149+, and keep visible-tab screenshots as the explicit opt-out path.
